...
muon_detector = face(0)
solenoid_borders = face(0)
solenoid_mid = face(0)
hcal = face(0)  # Fe absorber, middle parts complex
ecal = face(0)  # W absrober plates, silicon detector, have to weigh them appropriately
...
eleven = conic(
    ecal, 11, [38], (33.9 - 31) / (250.9 - 230.7), -250.9, -230.7, 31, "towards"
)
twelve = conic(
    space_between,
    12,
...
thirtyeight = cap(
    space_between, 38, [41, 42, 43, 44, 69, 70, 71, 72, 87], -230.7, 31, 170
)
